...
const InfoCard = ({total, percent}: props) => {
  return <div className="flex justify-between items-center py-4">
    <div className="flex flex-col">
      <p className="text-mediumBrown text-base opacity-75 sm:text-lg">Total this month</p>
    ...
    <div className="flex flex-col items-end">
      ...
      <p className="text-mediumBrown text-xs opacity-75 sm:text-sm">from last month</p>
    </div>
  </div>;
};
